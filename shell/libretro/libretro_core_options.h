...
struct retro_core_option_v2_category option_cats_us[] = {
   ...
   },
   {
      "netplay",
      "Netplay (Dojo GGPO)",
      "Configure Dojo GGPO rollback netplay settings."
   },
   {
      "vmu",
      "Visual Memory Unit",
...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   {
      CORE_OPTION_NAME "_ggpo_enable",
      "Dojo GGPO",
      NULL,
      "Enable internal Dojo GGPO netplay. Disable RetroArch netplay when using this.",
      NULL,
      "netplay",
      {
         { "disabled", NULL },
   ...
   {
      CORE_OPTION_NAME "_ggpo_role",
      "GGPO Role",
      NULL,
      "Select host or client for direct connect sessions.",
      NULL,
      "netplay",
      {
         { "client", NULL },
   ...
   {
      CORE_OPTION_NAME "_ggpo_remote_ip",
      "GGPO Remote IP",
      NULL,
      "Remote host IP address. For custom values, edit retroarch-core-options.cfg.",
      NULL,
      "netplay",
      {
         { "127.0.0.1",   NULL },
   ...
   {
      CORE_OPTION_NAME "_match_code_enable",
      "Dojo Match Codes",
      NULL,
      "Enable match-code matchmaking for Flycast Dojo sessions.",
      NULL,
      "netplay",
      {
         { "enabled",  NULL },
   ...
   {
      CORE_OPTION_NAME "_match_code",
      "Dojo Match Code",
      NULL,
      "Matchmaking code for Flycast Dojo sessions. For custom values, edit retroarch-core-options.cfg.",
      NULL,
      "netplay",
      {
         { "unset", NULL },
   ...
   {
      CORE_OPTION_NAME "_matchmaking_server",
      "Dojo Matchmaking Server",
      NULL,
      "Matchmaking server address for match-code sessions.",
      NULL,
      "netplay",
      {
         { "match.dojo.ooo", NULL },
   ...
   {
      CORE_OPTION_NAME "_matchmaking_port",
      "Dojo Matchmaking Port",
      NULL,
      "Matchmaking server port for match-code sessions.",
      NULL,
      "netplay",
      {
         { "52001", NULL },
   ...
   {
      CORE_OPTION_NAME "_ggpo_port",
      "GGPO Local Port",
      NULL,
      "Local UDP port for GGPO sessions. For custom values, edit retroarch-core-options.cfg.",
      NULL,
      "netplay",
      {
         { "19713", NULL },
   ...
   {
      CORE_OPTION_NAME "_ggpo_remote_port",
      "GGPO Remote Port",
      NULL,
      "Remote UDP port for GGPO peer. For custom values, edit retroarch-core-options.cfg.",
      NULL,
      "netplay",
      {
         { "19713", NULL },
   ...
   {
      CORE_OPTION_NAME "_ggpo_delay",
      "GGPO Input Delay",
      NULL,
      "Number of frames to delay local input. Increase if jitter causes stutter.",
      NULL,
      "netplay",
      {
         { "0",  NULL },
   ...
   {
      CORE_OPTION_NAME "_ggpo_analog_axes",
      "GGPO Analog Axes",
      NULL,
      "Select how many analog axes are synced in GGPO input.",
      NULL,
      "netplay",
      {
         { "disabled",   NULL },
   ...
   {
      CORE_OPTION_NAME "_ggpo_stats_overlay",
      "GGPO Stats Overlay",
      NULL,
      "Show GGPO network stats overlay during gameplay.",
      NULL,
      "netplay",
      {
         { "disabled", NULL },
   ...
   {
      CORE_OPTION_NAME "_ggpo_chat",
      "GGPO Chat",
      NULL,
      "Enable the GGPO chat window and notifications.",
      NULL,
      "netplay",
      {
         { "disabled", NULL },
   ...
   {
      CORE_OPTION_NAME "_ggpo_chat_timeout",
      "GGPO Chat Timeout",
      NULL,
      "Automatically close the chat window after a timeout.",
      NULL,
      "netplay",
      {
         { "disabled", NULL },
   ...
   {
      CORE_OPTION_NAME "_ggpo_chat_timeout_seconds",
      "GGPO Chat Timeout Seconds",
      NULL,
      "Seconds before closing the chat window. For custom values, edit retroarch-core-options.cfg.",
      NULL,
      "netplay",
      {
         { "5",  NULL },
   ...
   {
      CORE_OPTION_NAME "_ggpo_chat_timeout_on_send",
      "GGPO Chat Timeout On Send",
      NULL,
      "Apply the chat timeout after sending a message.",
      NULL,
      "netplay",
      {
         { "disabled", NULL },
