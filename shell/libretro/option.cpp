...
Option<bool> GGPOChat(CORE_OPTION_NAME "_ggpo_chat", true);
Option<bool> GGPOChatTimeoutToggle(CORE_OPTION_NAME "_ggpo_chat_timeout", true);
Option<bool> GGPOChatTimeoutToggleSend(CORE_OPTION_NAME "_ggpo_chat_timeout_on_send", false);
Option<int> GGPOChatTimeout(CORE_OPTION_NAME "_ggpo_chat_timeout_seconds", 10);
...
OptionString MatchmakingServerAddress(CORE_OPTION_NAME "_matchmaking_server", "match.dojo.ooo");
OptionString MatchmakingServerPort(CORE_OPTION_NAME "_matchmaking_port", "52001");
